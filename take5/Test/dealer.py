...
class Dealer:
    ...
    def create_deck(self: Dealer, deck_size, bull_points: float=0.5, order:
        float=0.5) ->List(Tuple(int, int)):
        """
    ...
    def update_game(self: Dealer, player: Player, stack_index: int, stacks:
        List(List(Tuple(int, int)))) ->Tuple(int, List(List(Tuple(int, int)))):
        """
    ...
    def replace_card(self: Dealer, card: Tuple(int, int), index: int,
        stacks: List(List(Tuple(int, int)))) ->List(List(Tuple(int, int))):
        """
