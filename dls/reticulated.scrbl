...
Reticulated Python is a micro-gradual typing system. It's implemented as a source-to-source translator, which means that it takes a Python program and generates Python code after adding the necessary checks to typecheck the program. The code is then executed as regular Python. paper@~cite[dls-2014]
