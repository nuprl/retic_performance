...
Instead of
allowing programmers to annotate arbitrary functions and classes, they
insist on annotating entire Racket modules with types. In 2016,
with Typed Racket under development for 10 years, Takikawa et al.'s
performance evaluation of Typed Racket indicates that this module-based form
