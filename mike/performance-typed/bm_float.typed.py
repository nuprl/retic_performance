...
Point = check_type_class(Point, ['normalize', 'maximize', '__init__', '__repr__'])
...
def benchmark(n):
    check_type_int(n)
    points = check_type_list([check0(Point(check_type_float(i))) for i in check_type_function(xrange)(n)])
